...
export function summarizeReadiness(
  ...
  if ((avgRpe !== undefined && avgRpe >= 8) || (maxRpe !== undefined && maxRpe >= 9) || painSignals.length >= 2) {
    level = "red";
  ...
  if (level === "red") {
    return {
      ...
      recommendation: "Reduce volume, avoid high-impact overload, and prioritize recovery until symptoms settle.",
    };
  }
